...
public class NotifyConfig extends Application {
    public static final String CHANEL_ID = "duongndbph29319";
    @Override
    ...
    private void onconfig() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            // Tên chanel
            CharSequence name = "Danh sách truyện"; // tên hiển thị trong cài đặt notify của điện thoại
            // mo ta:
            String mota = "If you read this book, you will be the better";
